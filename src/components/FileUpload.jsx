  ...
  return (
    <Card 
      ...
      className={cn(
        ...
        isDragActive || dragActive ? "border-primary bg-primary/5" : "border-upload-border"
      )}
    >
      <input {...getInputProps()} />
      <div className="p-8 text-center">
        ...
        <Button variant="outline" type="button" className="bg-primarylight text-white cursor-pointer">
